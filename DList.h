...
extern DListNode *DListGetHead( DList *pList );

/* Function declaration for DListGetIndex() */
extern int DListGetIndex( DList *pList, int pData );
...
extern DList* DListInsertBefore(DList *pList, int pBefore, int pData );

/* Function declaration for DListInsertIndex() */
extern DList* DListInsertIndex(DList *pList, int pIndex, int pData );

extern bool DListIsEmpty(DList *pList);

/* Function declaration for DListRemoveData() */
extern DList* DListRemoveData(DList *pList, int pData );

/* Function declaration for DListRemoveIndex() */
extern DList* DListRemoveIndex(DList *pList, int pIndex );
